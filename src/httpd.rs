...
impl Server {
    ...
    fn get_httpd_method(m: Method) -> esp_idf_sys::http_method {
        match m {
            Method::Get => esp_idf_sys::http_method::HTTP_GET,
            Method::Post => esp_idf_sys::http_method::HTTP_POST,
            Method::Delete => esp_idf_sys::http_method::HTTP_DELETE,
            Method::Head => esp_idf_sys::http_method::HTTP_HEAD,
            Method::Put => esp_idf_sys::http_method::HTTP_PUT,
            Method::Connect => esp_idf_sys::http_method::HTTP_CONNECT,
            Method::Options => esp_idf_sys::http_method::HTTP_OPTIONS,
            Method::Trace => esp_idf_sys::http_method::HTTP_TRACE,
            Method::Copy => esp_idf_sys::http_method::HTTP_COPY,
            Method::Lock => esp_idf_sys::http_method::HTTP_LOCK,
            Method::MkCol => esp_idf_sys::http_method::HTTP_MKCOL,
            Method::Move => esp_idf_sys::http_method::HTTP_MOVE,
            Method::Propfind => esp_idf_sys::http_method::HTTP_PROPFIND,
            Method::Proppatch => esp_idf_sys::http_method::HTTP_PROPPATCH,
            Method::Search => esp_idf_sys::http_method::HTTP_SEARCH,
            Method::Unlock => esp_idf_sys::http_method::HTTP_UNLOCK,
            Method::Bind => esp_idf_sys::http_method::HTTP_BIND,
            Method::Rebind => esp_idf_sys::http_method::HTTP_REBIND,
            Method::Unbind => esp_idf_sys::http_method::HTTP_UNBIND,
            Method::Acl => esp_idf_sys::http_method::HTTP_ACL,
            Method::Report => esp_idf_sys::http_method::HTTP_REPORT,
            Method::MkActivity => esp_idf_sys::http_method::HTTP_MKACTIVITY,
            Method::Checkout => esp_idf_sys::http_method::HTTP_CHECKOUT,
            Method::Merge => esp_idf_sys::http_method::HTTP_MERGE,
            Method::MSearch => esp_idf_sys::http_method::HTTP_MSEARCH,
            Method::Notify => esp_idf_sys::http_method::HTTP_NOTIFY,
            Method::Subscribe => esp_idf_sys::http_method::HTTP_SUBSCRIBE,
            Method::Unsubscribe => esp_idf_sys::http_method::HTTP_UNSUBSCRIBE,
            Method::Patch => esp_idf_sys::http_method::HTTP_PATCH,
            Method::Purge => esp_idf_sys::http_method::HTTP_PURGE,
            Method::MkCalendar => esp_idf_sys::http_method::HTTP_MKCALENDAR,
            Method::Link => esp_idf_sys::http_method::HTTP_LINK,
            Method::Unlink => esp_idf_sys::http_method::HTTP_UNLINK,
        }
    }
