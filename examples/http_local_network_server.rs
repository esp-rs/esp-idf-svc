...
//! so that any devices on the network
//! can access it.
//!
//! After connection serial monitor will print
//! "Server available at <IP of device>".
//! type the ip into the url bar of a web
//! browser to access site.
...
fn connect_wifi(wifi: &mut BlockingWifi<EspWifi<'static>>) -> anyhow::Result<()> {
    ...
    info!("Server available at {}",wifi.wifi().sta_netif().get_ip_info()?.ip);
